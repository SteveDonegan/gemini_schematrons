...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt" schemaVersion="1.2">
    ...
    <sch:pattern fpi="Gemini2-mi17-refSysInfo-recs">
        ...
        <sch:rule
            context="//gmd:MD_Metadata[1]/gmd:referenceSystemInfo/*[1]/gmd:MD_ReferenceSystem[1]/gmd:referenceSystemIdentifier[1]/gmd:RS_Identifier[1]/gmd:code/gmx:Anchor[1]/@xlink:href">
            <sch:assert
            ...
            <!--<sch:assert test="$defaultCRScodes/crs/text()[normalize-space(.) = normalize-space(current()/.)]">SP-4a: Coordinate Reference System: <sch:value-of
                select="normalize-space(current()/.)"/> is not a default CRS</sch:assert>-->
        </sch:rule>
        <sch:rule
